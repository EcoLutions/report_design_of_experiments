...
| v1.9.0  | 09/10/2025 | Jhosepmyr, Eric, Elmer, Salim, Paul  | Implementación completa del ecosistema WasteTrack incluyendo: Pipeline CI/CD enterprise-grade con GitHub Actions, Docker Hub y despliegue automatizado blue-green;  Documentación exhaustiva de prácticas DevOps (integración, entrega y despliegue continuo);  Implementación técnica completa con backend microservicios (Spring Boot), frontend web (Vue.js) y aplicaciones móviles (Flutter); Evidencias de testing unitario, integración y BDD;  Configuración de infraestructura cloud (Azure) con VMs Ubuntu y PostgreSQL; Documentación de API RESTful con OpenAPI 3.0 y Swagger UI;  Estrategias de monitoreo, logging y deployment automatizado. |
| v2.0.0  | 10/10/2025 | Jhosepmyr, Eric, Elmer, Salim, Paul  | Fase integral de Experimentación, Validación y Auditoría: Diseño y ejecución completa de experimentos (hipótesis, KPIs, análisis de resultados ""Aftermath""); Implementación de pipelines de monitoreo continuo y sistemas de alertas; Ejecución de pruebas estáticas, revisión de código y estándares de seguridad; Realización de entrevistas de validación con stakeholders (administradores, conductores, ciudadanos) y actualización del Product Backlog (To-Be) basado en aprendizaje validado y feedback de auditoría.                                                                                                                             |
...
* [Capítulo VI: Product Verification & Validation](#capítulo-vi-product-verification--validation)
    ...
    * [6.2. Static testing & Verification](#62-static-testing--verification)
        * [6.2.1. Static Code Analysis](#621-static-code-analysis)
            * [6.2.1.1. Coding standard & Code convention](#6211-coding-standard--code-convention)
  ...
  * [6.4. Auditoría de Experiencias de Usuario](#64-auditoría-de-experiencias-de-usuario)
    ...
    * [6.4.2. Auditoría recibida](#642-auditoría-recibida)
      ...
      * [6.4.2.3. Resumen de modificaciones para subsanar hallazgos](#6423-resumen-de-modificaciones-para-subsanar-hallazgos)
...
| **Criterio específico**                                                                                                                                           | **Acciones realizadas (TB1, TP1, TB2 y TF1)**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | **Conclusiones (TB1, TP1, TB2 y TF1)**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **4.c.1 Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software.**                                                                  | **TB1:**<br> - *Gutiérrez Soto, Jhosepmyr Orlando:* Supervisó el cumplimiento de convenciones éticas de desarrollo en el diseño del Domain-Driven Design y en la documentación técnica.<br> - *Hernández Tuiro, Eric Ernesto:* Veló por la protección de datos sensibles durante la transcripción y análisis de entrevistas.<br> - *Ramirez Mestanza, Salim Ignacio:* Promovió buenas prácticas en el versionamiento del código y la colaboración ética en Git.<br> - *Riva Rodríguez, Elmer Augusto:* Aseguró el uso de fuentes confiables para el análisis de impacto social y económico.<br> - *Sulca Gonzales, Paul Fernando:* Implementó lineamientos de diseño inclusivo y accesibilidad en las interfaces.<br><br>**TP1:**<br> - *Gutiérrez Soto, Jhosepmyr Orlando:* Garantizó la integridad del código backend aplicando estándares de *clean architecture*, asegurando un desarrollo profesional y mantenible.<br> - *Hernández Tuiro, Eric Ernesto:* Gestionó éticamente los permisos de repositorios y ramas protegidas para asegurar la integridad del código fuente compartido.<br> - *Ramirez Mestanza, Salim Ignacio:* Implementó las primeras suites de pruebas unitarias para validar honestamente la funcionalidad del núcleo del sistema sin sesgos.<br> - *Riva Rodríguez, Elmer Augusto:* Diseñó componentes web respetando estándares de accesibilidad (WCAG) para garantizar un uso profesional e inclusivo.<br> - *Sulca Gonzales, Paul Fernando:* Desarrolló la estructura base móvil siguiendo estrictamente las guías de estilo de Material Design, demostrando profesionalismo técnico.<br><br>**TB2:**<br> - *Gutiérrez Soto, Jhosepmyr Orlando:* Supervisó la correcta implementación del backend bajo principios de arquitectura limpia y aplicó prácticas de testing ético, garantizando la trazabilidad de los datos en los servicios REST.<br> - *Hernández Tuiro, Eric Ernesto:* Mantuvo la coherencia ética en la manipulación de información sensible y validación de tokens en la capa de seguridad durante las pruebas de integración.<br> - *Ramirez Mestanza, Salim Ignacio:* Aseguró el cumplimiento de las normas de codificación y control de versiones, además de documentar de forma transparente las pruebas unitarias e integradas.<br> - *Riva Rodríguez, Elmer Augusto:* Promovió la ética profesional al validar la consistencia de los controladores REST y la documentación API con principios de transparencia y mantenibilidad.<br> - *Sulca Gonzales, Paul Fernando:* Garantizó que el frontend cumpla criterios de accesibilidad y usabilidad ética, priorizando la experiencia del usuario final sin sesgos visuales ni técnicos.<br><br>**TF1:**<br> - *Gutiérrez Soto, Jhosepmyr Orlando:* Documentó de manera transparente y estandarizada la API RESTful (OpenAPI/Swagger), facilitando la integración ética para futuros desarrolladores.<br> - *Hernández Tuiro, Eric Ernesto:* Configuró pipelines de CI/CD seguros, manejando secretos y credenciales de producción con responsabilidad profesional para evitar vulnerabilidades.<br> - *Ramirez Mestanza, Salim Ignacio:* Ejecutó análisis estáticos de código (SonarQube) para identificar y corregir deuda técnica, actuando con diligencia profesional ante la calidad del software.<br> - *Riva Rodríguez, Elmer Augusto:* Procesó los resultados de la auditoría UX de forma honesta, implementando correcciones críticas para garantizar la calidad del producto entregado.<br> - *Sulca Gonzales, Paul Fernando:* Validó la aplicación móvil con usuarios reales, respetando su privacidad y feedback durante las pruebas de campo y experimentos.                                                                                                                                                             | **TB1:** El equipo mostró un alto nivel de responsabilidad ética y profesional en todas las etapas del proyecto. Se mantuvo un compromiso con el uso responsable de la información, el cumplimiento de estándares técnicos y la transparencia en la colaboración.<br><br>**TP1:** Durante el Trabajo Parcial, el equipo demostró profesionalismo al establecer bases técnicas sólidas, priorizando la calidad del código y la arquitectura sobre soluciones rápidas pero inestables, respetando las normas de ingeniería.<br><br>**TB2:** En esta segunda etapa, el equipo reafirmó su compromiso ético en la fase de desarrollo y pruebas. Se priorizó la calidad técnica, la seguridad de los datos y la accesibilidad del sistema. Las decisiones de implementación reflejaron respeto por los estándares éticos de la ingeniería de software.<br><br>**TF1:** En la entrega final, el equipo consolidó su responsabilidad profesional mediante la implementación de prácticas DevOps, seguridad en el despliegue y validación rigurosa. La gestión transparente de la deuda técnica y la auditoría externa demostraron un juicio ético maduro y preparado para el entorno productivo. |
| **4.c.2 Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales.** | **TB1:**<br> - *Gutiérrez Soto, Jhosepmyr Orlando:* Evaluó el impacto económico de la solución al justificar la reducción de costos operativos para municipios.<br> - *Hernández Tuiro, Eric Ernesto:* Incorporó las necesidades sociales de los ciudadanos en el diseño funcional del sistema a partir de entrevistas.<br> - *Ramirez Mestanza, Salim Ignacio:* Consideró el impacto ambiental al definir funcionalidades que promuevan la recolección oportuna de residuos.<br> - *Riva Rodríguez, Elmer Augusto:* Relacionó el alcance del producto con escenarios de implementación a nivel nacional y en otros contextos globales.<br> - *Sulca Gonzales, Paul Fernando:* Analizó la interoperabilidad de la solución en entornos con limitaciones tecnológicas y propuso alternativas sostenibles.<br><br>**TP1:**<br> - *Gutiérrez Soto, Jhosepmyr Orlando:* Lideró la arquitectura técnica y el diseño del backend, evaluando el impacto en la escalabilidad y rendimiento del sistema para municipios de diferentes tamaños.<br> - *Hernández Tuiro, Eric Ernesto:* Implementó y validó la integración de componentes críticos, analizando el impacto en la estabilidad y confiabilidad del sistema para entornos de alta concurrencia.<br> - *Ramirez Mestanza, Salim Ignacio:* Desarrolló la estrategia de testing automatizado, considerando el impacto económico de reducir fallos en producción y el beneficio ambiental de optimizar recursos computacionales.<br> - *Riva Rodríguez, Elmer Augusto:* Coordinó el desarrollo frontend y la experiencia de usuario, evaluando el impacto social en la accesibilidad y usabilidad para diferentes segmentos de usuarios municipales.<br> - *Sulca Gonzales, Paul Fernando:* Implementó las interfaces de usuario y validó la responsividad, analizando el impacto en la inclusión digital y la reducción de brechas tecnológicas en contextos municipales diversos.<br><br>**TB2:**<br> - *Gutiérrez Soto, Jhosepmyr Orlando:* Evaluó el impacto social y económico de la implementación del backend en la eficiencia operativa de los servicios municipales.<br> - *Hernández Tuiro, Eric Ernesto:* Analizó la contribución del sistema al bienestar social mediante la digitalización de procesos de monitoreo y gestión urbana.<br> - *Ramirez Mestanza, Salim Ignacio:* Valoró el impacto ambiental de las pruebas BDD y la automatización de rutas en la reducción del consumo de recursos físicos.<br> - *Riva Rodríguez, Elmer Augusto:* Consideró la escalabilidad del sistema para su aplicación en otros contextos nacionales e internacionales, promoviendo interoperabilidad tecnológica.<br> - *Sulca Gonzales, Paul Fernando:* Reflexionó sobre el impacto social del frontend al mejorar la comunicación entre ciudadanos y entidades municipales, fomentando la transparencia en la gestión de residuos.<br><br>**TF1:**<br> - *Gutiérrez Soto, Jhosepmyr Orlando:* Optimizó la infraestructura en la nube (Azure) evaluando el costo-beneficio económico y el menor impacto energético de servidores eficientes.<br> - *Hernández Tuiro, Eric Ernesto:* Evaluó el impacto de la seguridad automatizada en la confianza social hacia las instituciones públicas que usarán el software.<br> - *Ramirez Mestanza, Salim Ignacio:* Analizó métricas de calidad para reducir el desperdicio de recursos en mantenimiento correctivo, favoreciendo la sostenibilidad económica del proyecto.<br> - *Riva Rodríguez, Elmer Augusto:* Validó mediante experimentos cómo la transparencia de información impacta positivamente en la percepción social y satisfacción ciudadana.<br> - *Sulca Gonzales, Paul Fernando:* Evaluó el rendimiento de la app móvil en dispositivos de gama media/baja, asegurando un impacto social inclusivo en la gestión de residuos. | **TB1:** A lo largo del desarrollo, el equipo realizó juicios informados al considerar cómo su solución influye en el entorno. Se tomaron en cuenta factores económicos, ambientales y sociales para maximizar el valor público del sistema.<br><br>**TP1:** El equipo demostró madurez al implementar una solución técnica que considera integralmente los impactos. La arquitectura diseñada permite escalabilidad y optimización de recursos, asegurando sostenibilidad operativa.<br><br>**TB2:** Los integrantes fortalecieron su capacidad de análisis sobre el impacto global. Las decisiones técnicas se fundamentaron en su valor económico, social y ambiental, considerando la interoperabilidad y accesibilidad.<br><br>**TF1:** En la fase final, el equipo emitió juicios informados basados en métricas reales de despliegue y experimentación. Se validó que la solución no solo es técnicamente viable, sino que genera un impacto positivo medible en la eficiencia económica municipal, la sostenibilidad ambiental y la inclusión social digital.                                                                                                                     |
...
1. ¿Cuál es su nombre, edad y distrito de residencia?
2. ¿A qué se dedica actualmente y cuánto interactúa con servicios municipales o de limpieza pública?
3. ¿Ha utilizado antes alguna aplicación o plataforma para la gestión de servicios municipales o de limpieza?
...
| **Atributo**            | **Detalle**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|-------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Nombre**              | Gustavo Antonio Pérez Rojas                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| **Edad**                | 22 años                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **Sexo**                | Masculino                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Distrito**            | San Juan de Miraflores                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **Ocupación**           | Estudiante (Computación)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Fecha de entrevista** | 04/12/2025                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| **Captura**             | ![img.png](assets/6.product-verification-validation/6.3.validation-interviews/6.3.2.registro-de-entrevistas/img.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **Resumen**             | Gustavo comentó al inicio que su interacción con los servicios municipales es baja, limitándose a sacar la basura. Durante la prueba de la aplicación, realizó el registro e inicio de sesión mediante Google y seleccionó la municipalidad de Surco sin inconvenientes.<br><br>Calificó la aplicación como muy intuitiva ("todo muy lógico") y fácil de usar. Destacó positivamente la diferenciación de colores en los botones y el mapa, lo cual le facilitó identificar las funciones principales rápidamente. La navegación entre pantallas le resultó fluida.<br><br>En cuanto a las funcionalidades específicas, mencionó que el proceso de creación de reportes (ubicación y tipo de incidencia) es claro y sencillo. Asimismo, valoró la utilidad de poder ver el estado y la capacidad de los contenedores inteligentes en el mapa, señalando que esto le ahorraría tiempo al evitar viajes innecesarios a tachos llenos. Concluyó que el punto más fuerte de la aplicación es su usabilidad. |
| **Link de video**       |  https://upcedupe-my.sharepoint.com/personal/u202220829_upc_edu_pe/_layouts/15/stream.aspx?id=%2Fpersonal%2Fu202220829%5Fupc%5Fedu%5Fpe%2FDocuments%2Fentrevista%2Fakv%2Dnxvy%2Dfpp%20%282025%2D12%2D04%2009%5F41%20GMT%2D5%29%2Emp4&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0&ga=1&referrer=StreamWebApp%2EWeb&referrerScenario=AddressBarCopied%2Eview%2Efb6c2788%2D875a%2D48b8%2D9e74%2Db005a756d47d                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| **Sexo**                  | Masculino                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Distrito**              | San Borja                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Ocupación**             | Programador (Municipalidad - Área de Tecnología)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **Fecha de entrevista**   | 04/12/2025                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| **Captura**               | ![img_1.png](assets/6.product-verification-validation/6.3.validation-interviews/6.3.2.registro-de-entrevistas/img_1.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Resumen**               | José trabaja como programador en el área de tecnología de la municipalidad, por lo que tiene experiencia previa con software de gestión tributaria. Respecto a la **Landing Page**, comentó que el diseño se ve muy limpio, ordenado y profesional. Destacó que los testimonios de otros administradores generan confianza desde la primera impresión.<br><br>Durante la prueba de la **plataforma para administradores**, completó el registro y validación por correo. Luego probó funcionalidades clave como crear contenedores, gestionar flotas (vehículos) y usuarios (conductores). Calificó la aplicación como muy intuitiva, resaltando la utilidad del menú lateral ("Sidebar") y la claridad de los íconos (ej. el bloque para contenedores, el camión para flota).<br><br>José mencionó que la aplicación es rápida, fluida y está bien sincronizada. Como punto fuerte destacó la integración del mapa y la facilidad de navegación. Sin embargo, sugirió una mejora específica en la experiencia de usuario (UX): al crear un contenedor, el mapa se centra por defecto en el centro de Lima, obligándolo a desplazarse ("scrollear") manualmente hasta su distrito (San Borja). Recomendó que el mapa se ubique automáticamente en el distrito registrado del administrador para ahorrar tiempo.  |
 | **Link de video**         | https://upcedupe-my.sharepoint.com/:v:/g/personal/u202220829_upc_edu_pe/IQALo74uX3iMQ5LuUq2HQw0dAcrm-w35Db_fWMS4x9chcrQ?e=vY347C&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
